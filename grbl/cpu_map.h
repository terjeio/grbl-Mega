...
#define cpu_map_h
  ...
  #define SERIAL_RX2 USART1_RX_vect
  ...
  // Define MPG input switch pin.
  #define MPG_DDR      DDRJ
  #define MPG_PORT     PORTJ
  #define MPG_PIN      PINJ
  #define MPG_BIT      1		  // MEGA2560 Digital Pin 23
  #define MPG_INT	   PCIE1  // Pin change interrupt enable pin
  #define MPG_INT_vect PCINT1_vect 
  #define MPG_PCMSK    PCMSK1 // Pin change interrupt register
  #define MPG_MASK     (1<<MPG_BIT) // 
  #define MPG_IMASK    (1<<2) // 
